# Bootcamp-santander-api-2023

API RESTful Bank Santander Dev 2023 desenvolvido em Java 17 com Spring Boot 3.
...
## Principais Tecnologias
 ...
 - **OpenAPI (Swagger)**: Criarmos uma documentação de API eficaz e fácil de entender usando a OpenAPI (Swagger), perfeitamente alinhada com a alta produtividade que o Spring Boot oferece;
